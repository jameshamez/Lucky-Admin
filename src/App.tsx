...
import ProcurementProductionOrder from "./pages/procurement/ProductionOrder";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/procurement/estimation/production-order" element={
            <DashboardLayout>
              <ProcurementProductionOrder />
            </DashboardLayout>
          } />
