...
import { JobUpdateForm } from "@/components/design/JobUpdateForm";
...
const mockJobs: JobOrder[] = [
  ...
  },
  {
    ...
    description: "เหรียญสำเร็จรูป ทอง-เงิน-ทองแดง จำนวน 50 เหรียญ จัดเรียงในกล่อง",
  ...
  },
  {
    ...
    description: "เหรียญสั่งทำพิเศษ ขนาด 5 ซม. ปั้มลายนูน มีสายแขวน",
    reference_images: ["https://placehold.co/400x300/png?text=Custom+Medal"],
    reference_files: ["design_brief.pdf"]
  },
  {
    job_id: "JOB-2024-004",
    client_name: "โรงแรม GHI",
    ...
    description: "โล่คริสตัลสีใส จารึกชื่อและตำแหน่ง พร้อมฐานไม้",
    reference_images: ["https://placehold.co/400x300/png?text=Trophy+Design"],
    reference_files: []
  },
  ...
  // รับแล้ว (ยังไม่เริ่ม) (แท็บ B)
  {
    ...
    assigned_at: "2024-11-29T08:00:00",
    ordered_by: "พนักงานขาย มานะ",
    quotation_no: "QT-2024-005",
    description: "เสื้อโปโล สกรีนโลโก้หน้า-หลัง ขนาด L, XL, XXL",
    reference_images: ["https://placehold.co/400x300/png?text=Shirt+Design"],
    reference_files: ["logo_vector.ai"]
  },
  {
    job_id: "JOB-2024-006",
    client_name: "ร้าน MNO",
    job_type: "บิบ",
    urgency: "ด่วน 1 วัน",
    due_date: "2024-12-06",
    order_date: "2024-11-27",
    ...
    assigned_at: "2024-11-29T09:00:00",
    ordered_by: "พนักงานขาย สุดา",
    quotation_no: "QT-2024-006",
    description: "บิบพลาสติก ขนาด 7x10 ซม. พิมพ์ชื่อและตำแหน่ง 4 สี",
    reference_images: ["https://placehold.co/400x300/png?text=Badge+Design"],
    reference_files: ["employee_list.xlsx"]
  },
  {
    job_id: "JOB-2024-007",
    client_name: "บริษัท PQR",
    job_type: "สายคล้อง",
    urgency: "ด่วน 2 วัน",
    due_date: "2024-12-08",
    order_date: "2024-11-28",
    ...
    assigned_at: "2024-11-29T10:00:00",
    ordered_by: "พนักงานขาย จินดา",
    quotation_no: "QT-2024-007",
    description: "สายคล้องคอ กว้าง 2 ซม. พิมพ์ซ้ำโลโก้และชื่อบริษัท",
    reference_images: ["https://placehold.co/400x300/png?text=Lanyard+Design"],
    reference_files: ["brand_guideline.pdf"]
  },
...
export default function JobOrderManagement() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="unassigned" className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="inprogress">
            กำลังทำ/ติดตาม ({inProgressJobs.length})
          </TabsTrigger>
          ...
          <Card>
            <div className="overflow-x-auto">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="w-[120px] sticky left-0 bg-background">Job ID</TableHead>
                    <TableHead>ชื่อลูกค้า</TableHead>
                    <TableHead>ประเภทงาน</TableHead>
                    <TableHead>ความเร่งด่วน</TableHead>
                    <TableHead>วันที่สั่งงาน</TableHead>
                    <TableHead>กำหนดส่ง</TableHead>
                    <TableHead>วันที่เหลือ</TableHead>
                    <TableHead className="sticky right-0 bg-background text-right">การกระทำ</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {unassignedJobs.map((job) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>{new Date(job.order_date).toLocaleDateString("th-TH")}</TableCell>
                        <TableCell>{new Date(job.due_date).toLocaleDateString("th-TH")}</TableCell>
                        <TableCell>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>รับงานเมื่อ</TableHead>
                    <TableHead>กำหนดส่ง</TableHead>
                    <TableHead>วันที่เหลือ</TableHead>
                    <TableHead>รอมา (ชม.)</TableHead>
                    <TableHead className="sticky right-0 bg-background text-right">การกระทำ</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>รอบแก้ไข</TableHead>
                    <TableHead>ข้อเสนอแนะ</TableHead>
                    <TableHead className="sticky right-0 bg-background text-right">การกระทำ</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
      ...
      {/* Dialog สำหรับอัปเดตงาน */}
      <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            <DialogTitle>อัปเดตงาน</DialogTitle>
            <DialogDescription>
