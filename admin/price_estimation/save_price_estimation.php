...
try {
    ...
    if ($is_update) {
        ...
        // 31 strings, 4 doubles, 2 strings = 37 params
        $stmt->bind_param("sssssssssssssssssssssssssssssssddddss",
            $data->customerId, $data->salesOwnerId, $data->estimateDate, $data->jobName,
            $data->productCategory, $data->productType, $data->quantity, $data->budget, $data->status,
            $data->eventDate, $data->material, $data->customMaterial, $data->hasDesign, $data->designDescription, $data->estimateNote,
            $data->medalSize, $data->medalThickness, $selected_colors, $front_details, $back_details,
            $data->lanyardSize, $data->lanyardPatterns, $data->strapSize, $data->strapPatternCount, $data->sewingOption,
            $data->awardDesignDetails, $data->plaqueOption, $data->plaqueText, $data->inscriptionPlate, $data->inscriptionDetails,
            $data->genericDesignDetails, $data->width, $data->length, $data->height, $data->thickness, $attached_files,
            $id
        );
        ...
        // 32 strings, 4 doubles, 1 string = 37 params
        $stmt->bind_param("ssssssssssssssssssssssssssssssssdddds",
            $id,
            $data->customerId, $data->salesOwnerId, $data->estimateDate, $data->jobName,
            $data->productCategory, $data->productType, $data->quantity, $data->budget, $data->status,
            $data->eventDate, $data->material, $data->customMaterial, $data->hasDesign, $data->designDescription, $data->estimateNote,
